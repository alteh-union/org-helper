...
/**
 * Command to get suggestions about available roles in the org.
 * @alias GetRoleSuggestions
 * @extends GetMentionSuggestions
 */
class GetRoleSuggestions extends GetMentionSuggestions {
  /**
  ...
  static createForOrg(context, source, commandLangManager, orgId) {
    return new GetRoleSuggestions(context, source, commandLangManager, orgId);
  }
  ...
  static getCommandInterfaceName() {
    return 'get_role_suggestions_name';
  }
...
/**
 * Exports the GetRoleSuggestions class
 * @type {GetRoleSuggestions}
 */
module.exports = GetRoleSuggestions;
