...
/**
 * Command to get suggestions about available users in the org.
 * @alias GetUserSuggestions
 * @extends GetMentionSuggestions
 */
class GetUserSuggestions extends GetMentionSuggestions {
  /**
  ...
  static createForOrg(context, source, commandLangManager, orgId) {
    return new GetUserSuggestions(context, source, commandLangManager, orgId);
  }
  ...
  static getCommandInterfaceName() {
    return 'get_user_suggestions_name';
  }
...
/**
 * Exports the GetUserSuggestions class
 * @type {GetUserSuggestions}
 */
