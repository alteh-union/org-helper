...
/**
 * @module get-user-setting-suggestions
...
/**
 * Command to get suggestions about possible user settings in the Discord org.
 * @alias GetUserSettingSuggestions
 * @extends DiscordCommand
 */
class GetUserSettingSuggestions extends DiscordCommand {
  /**
  ...
  static createForOrg(context, source, commandLangManager, orgId) {
    return new GetUserSettingSuggestions(context, source, commandLangManager, orgId);
  }
  ...
  static getCommandInterfaceName() {
    return 'get_user_setting_suggestions_name';
  }
...
/**
 * Exports the GetUserSettingSuggestions class
 * @type {GetUserSettingSuggestions}
 */
module.exports = GetUserSettingSuggestions;
