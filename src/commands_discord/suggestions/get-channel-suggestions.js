...
/**
 * @module get-channel-suggestions
...
/**
 * Command to get suggestions about available channels in the org.
 * @alias GetChannelSuggestions
 * @extends GetMentionSuggestions
 */
class GetChannelSuggestions extends GetMentionSuggestions {
  /**
  ...
  static createForOrg(context, source, commandLangManager, orgId) {
    return new GetChannelSuggestions(context, source, commandLangManager, orgId);
  }
  ...
  static getCommandInterfaceName() {
    return 'get_channel_suggestions_name';
  }
...
/**
 * Exports the GetChannelSuggestions class
 * @type {GetChannelSuggestions}
 */
module.exports = GetChannelSuggestions;
