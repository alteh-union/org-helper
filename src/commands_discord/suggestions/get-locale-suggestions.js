 ...
 * @alias GetLocaleSuggestions
 * @extends DiscordCommand
 */
class GetLocaleSuggestions extends DiscordCommand {
  /**
  ...
  static createForOrg(context, source, commandLangManager, orgId) {
    return new GetLocaleSuggestions(context, source, commandLangManager, orgId);
  }
  ...
  static getCommandInterfaceName() {
    return 'get_locale_suggestions_name';
  }
  ...
  async executeForDiscord(message) {
    ...
    for (const locale of locales) {
      message.replyResult.suggestions.push(new ArgSuggestion(locale, ""));
    }
  }
}

/**
 * Exports the GetLocaleSuggestions class
 * @type {GetLocaleSuggestions}
 */
module.exports = GetLocaleSuggestions;
