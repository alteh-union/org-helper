...
class PermissionsCommand extends DiscordCommand {
  ...
  async executeForDiscord(discordMessage) {
    ...
    return await this.getPermissionsDescription(discordMessage, 'command_permissions_no_permissions',
  ...
  async getPermissionsDescription(discordMessage, emptyTextId, resultTextId) {
    ...
    for (const permission of permissions) {
      ...
      result = result + this.langManager.getString(resultTextId, permission.id,
        permType, subjectTypeString, subjectString, filterDescription) + '\n';
    }
