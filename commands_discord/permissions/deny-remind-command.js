  ...
  async executeForDiscord(discordMessage) {
    ...
    for (const permission of permissions) {
      ...
      if (this.channelIds.channels.includes(OhUtils.ANY_VALUE)) {
        channelMatch = true;
      } else if (this.channelIds.channels.includes(
        permission.filter[PermissionsManager.DEFINED_FILTERS.channelId.name])) {
        channelMatch = true;
      }
      ...
      results.push(this.context.dbManager.deleteDiscordRows(this.context.dbManager.permissionsTable,
        this.orgId, deleteQuery));
      count++;
    }
