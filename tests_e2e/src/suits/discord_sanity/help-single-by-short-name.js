...
/**
 * @module help-single-by-short-name
...
/**
 * Checks the output of the help when specified a single command with scanning args by name with short aliases.
 * @extends TestCase
 * @alias HelpSingleByShortName
 */
class HelpSingleByShortName extends TestCase {
  /**
...
/**
 * Exports the HelpSingleByShortName class
 * @type {HelpSingleByShortName}
 */
module.exports = HelpSingleByShortName;
