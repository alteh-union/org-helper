...
/**
 * @module help-single-by-full-name
...
/**
 * Checks the output of the help when specified a single command with scanning args by name with full aliases.
 * @extends TestCase
 * @alias HelpSingleByFullName
 */
class HelpSingleByFullName extends TestCase {
  /**
  ...
  async execute() {
    ...
    channel.send('!help -command help');
...
/**
 * Exports the HelpSingleByFullName class
 * @type {HelpSingleByFullName}
 */
module.exports = HelpSingleByFullName;
