...
/**
 * @module roles-permissions-remove-any-role
...
/**
 * Checks if the bot removes role management to all roles at once.
 * @extends TestCase
 * @alias RolesPermissionsRemoveAnyRole
 */
class RolesPermissionsRemoveAnyRole extends TestCase {
  /**
...
/**
 * Exports the RolesPermissionsRemoveAnyRole class
 * @type {RolesPermissionsRemoveAnyRole}
 */
module.exports = RolesPermissionsRemoveAnyRole;
